...
class LocNotification
{
  ...
  static AndroidNotificationChannel localNotificationAppChannel = const AndroidNotificationChannel(
  ...
  static Future init(BuildContext context) async
  {
    ...
    await flutterLocalNotificationsPlugin.resolvePlatformSpecificImplementation<AndroidFlutterLocalNotificationsPlugin>()?.createNotificationChannel(localNotificationAppChannel);
