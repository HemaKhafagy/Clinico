...
class BitmapDescriptorGenerator{
  static final BitmapDescriptorGenerator _singleton = BitmapDescriptorGenerator._internal();

  factory BitmapDescriptorGenerator() => _singleton;

  BitmapDescriptorGenerator._internal();

  Future<BitmapDescriptor?> getBitmapDescriptorByImagePath(String imagePath) async{
    img.Image? doneImg;
